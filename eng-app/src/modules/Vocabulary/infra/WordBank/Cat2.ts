...
const c3 = [
  ...
  { english: 'child', chinese: '小孩 (單數)(較正式)' },
  { english: 'kid', chinese: '小孩 (較口語)' },
...
const c4 = [
  { english: 'grandfather', chinese: '祖父/外祖父(長)' },
  { english: 'grandpa', chinese: '爺爺/外公(短)' },
  { english: 'grandmother', chinese: '祖母/外祖母(長)' },
  { english: 'grandma', chinese: '奶奶/外婆(短)' },
...
const c6 = [
  ...
  // { english: 'trip', chinese: '旅程 (單次事件)' }, //bonus
  // { english: 'travel', chinese: '旅行 (行為/概念)' }, //bonus
  // { english: 'journey', chinese: '旅途 (強調路程本身)' }, //bonus
...
export default [...c1, ...c2, ...c3, ...c4, ...c5, ...c6, ...c7, ...c8, ...c9, ...c10];
